...
-- =====================================================
CREATE TABLE dwh_hr.dim_profession (
    profession_key INT IDENTITY(1,1) PRIMARY KEY,
    
    source_system_code NVARCHAR(50) NOT NULL,
    source_profession_id NVARCHAR(50),
    
    profession_name NVARCHAR(300),
    profession_code NVARCHAR(50),
    profession_category NVARCHAR(100),
